      ...
      <div className="container" style={{ paddingBottom: '75px' }}>
        ...
        <div className="row justify-content-md-center">
          <div className="col-4 text-center">
            ...
            <img onClick={() => { this.buttonClick(1) }} className="img-fluid" alt="scatterplot" src="img/example07b.png"/>
          </div>
          <div className="col-4">
            <img style={{ border: '2px solid #A79AFF' }} className="img-fluid" alt="scatterplot" src="img/example07a.png"/>
          ...
          <div className="col-4 text-center">
            ...
            <img onClick={() => { this.buttonClick(0) }} className="img-fluid" alt="scatterplot" src="img/example07c.png"/>
          </div>
        </div>
