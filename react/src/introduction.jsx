      ...
      <div className="container" style={{ paddingBottom: '75px' }}>
        ...
        <p><strong>Contact Information</strong>: If you have any questions, concerns, or complaints about this study, email Dr. Paul Rosen (prosen@usf.edu) or Ghulam Jilani Quadri (ghulamjilani@usf.edu).</p>
         ...
         <div className="text-center">
          <button type="button" className="btn btn-secondary" style={{ width: '100px' }} onClick={this.props.previousPage}>No</button>
          <button type="button" className="btn btn-primary" style={{ marginLeft: '10px', width: '100px' }} onClick={this.props.nextPage}>I consent</button>
        </div>
